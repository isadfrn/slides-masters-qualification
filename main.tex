...
\begin{document}
	...
	\section{Fundamentação Teórica}
		...
		\begin{frame}{Estrutura da Formação}
			\begin{center}
				\includegraphics[width=1\textwidth]{./images/desenho1.png}
			\end{center}
		\end{frame}
		...
		\begin{frame}{Mecânica de Pontuação e Emblemas}
			\begin{center}
				\includegraphics[width=1\textwidth]{./images/desenho3.png}
			\end{center}
		\end{frame}
		% -------------------------- O Funil de Ranqueamento e Classificação
		\begin{frame}{O Funil de Ranqueamento e Classificação}
			\begin{center}
				\includegraphics[width=1\textwidth]{./images/desenho2.png}
			\end{center}
		\end{frame}
	...
	\section{Trabalhos Relacionados}
		...
		\begin{frame}{Artigos selecionados}
			\vspace{0.2cm}
			\centering
			{\footnotesize Avaliação multidimensional dos trabalhos selecionados (Escala 1--5)\par}
			\vspace{0.25cm}
			\resizebox{\textwidth}{!}{%
			\begin{footnotesize}
		...
		\begin{frame}{Artigos selecionados}
			\begin{center}
				\includegraphics[width=1\textwidth]{./images/analise-multidimensional.png}
			\end{center}
		\end{frame}
