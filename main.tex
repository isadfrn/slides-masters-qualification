...
\begin{document}
	...
	\section{Proposta}
		...
		\begin{frame}{Levantamento de Percepção}
			\begin{itemize}
				\justifying
				\item Objetivo (Goal): Baseado em Hogan et al. (2025), espera-se que o ranking público tenha correlação positiva com a ansiedade em mulheres, ao contrário de feedbacks privados.
				\item Perguntas (Questions): Como o \textit{ranking} afeta a sua ansiedade?
				\item Métricas (Metrics): Escala Likert (1-5): \enquote{A visualização da minha posição no ranking me causa ansiedade.}
			\end{itemize}
		\end{frame}
	% -------------------------- Fim da Proposta
    % -------------------------- Avaliação
	\subsection{Avaliação}
		\begin{frame}{Avaliação com Participantes do programa}
			\begin{itemize}
				\justifying
				\item Objetivo (Goal): Espera-se que o suporte social seja citado como fator determinante de retenção
				\item Perguntas (Questions): A existência de canais de suporte ou comunidades (fóruns/grupos) influenciou a decisão de permanecer no curso?
				\item Métricas (Metrics): Escala dicotômica
			\end{itemize}
		\end{frame}
	% -------------------------- Avaliação
		\begin{frame}{Avaliação com Painel de Especialistas}
			\begin{itemize}
				\justifying
				\item Objetivo (Goal): Especialistas podem apontar resistência se a narrativa for percebida como infantilização do conteúdo
				\item Perguntas (Questions): As diretrizes de \enquote{Contextualização Narrativa} são aplicáveis sem descaracterizar o rigor técnico do conteúdo?
				\item Métricas (Metrics): Escala Likert (1-5)
			\end{itemize}
		\end{frame}
	% -------------------------- Fim da Análise de Riscos
	% -------------------------- Análise de Riscos
	\subsection{Análise de Riscos}
		\begin{frame}{Análise de Riscos}
			\begin{itemize}
				\justifying
	...
	% -------------------------- Fim do Cronograma
	% -------------------------- Publicações
	\subsection{Submissão de Artigo}
		\begin{frame}{Submissão de Artigo}
			\begin{center}
